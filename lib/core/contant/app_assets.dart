...
class AppAssets {
  ...
  /// App logo
  ///
  static String appLogo = "$staticAssets/app_logo.png";
  ...
  /// Root Screen
  ///
  static String homeIcon = "$iconsAssets/home.png";
  static String gamesIcon = "$iconsAssets/games.png";
  ...
  static String editIcon = "$iconsAssets/editIcon.png";
  ...
  static String city4 = "$dynamicAssets/city4.png";
}
